...
namespace Marain.Claims.OpenApi.Specs.Bindings
{
    ...
    public static class TransientTenantBindings
    {
        ...
        /// <summary>
        /// Tear down the parent transient tenant at the end of the feature.
        /// </summary>
        /// <param name="featureContext">The feature context.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
        [AfterFeature("@useTransientTenant", Order = BindingSequence.TransientTenantTearDown)]
        public static async Task TearDownTransientTenant(FeatureContext featureContext)
        {
            await TransientTenantManager.GetInstance(featureContext).CleanupAsync().ConfigureAwait(false);
        }
